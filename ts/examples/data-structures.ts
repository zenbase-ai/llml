...
export async function analyzeOrganizationalStructure(departmentId: string) {
    ...
    organization: {
      department: {
        ...
        aggregates: {
          ...
          growthPlan: orgChart.metrics.plannedHeadcount - orgChart.metrics.totalHeadcount,
      ...
      workload: {
        activeProjects: projects.map(project => ({
          ...
          budgetHealth: {
            ...
            onTrack: project.budget.spent / project.budget.allocated <= project.timeline.progress,
          },
          riskProfile: {
      ...
      performance: {
        teamVelocity: Object.entries(performance.productivity.velocity).map(([team, metrics]) => ({
          team,
        ...
        collaborationHealth: {
          ...
          knowledgeSharing: performance.collaboration.knowledgeSharing.techTalks,
